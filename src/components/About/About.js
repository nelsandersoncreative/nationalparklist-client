  ...
  <div>
    ...
    <div className='about-subtext'>
      ...
      <div className='api-cont'>
        <p className='about-apis'>The National Park Service&apos;s API:</p>
        <a href='https://www.nps.gov/subjects/developer/api-documentation.htm' target='_blank' rel='noopener noreferrer'>Click Here to Learn More about the National Parks Service API</a>
        <br />
      </div>
      <div className='api-cont'>
        <p className='about-apis'>The Open Weather API:</p>
        <a href='https://openweathermap.org/api' target='_blank' rel='noopener noreferrer'>Click Here to Learn More about the OpenWeather API</a>
      </div>
    </div>
    <br />
    <br />
