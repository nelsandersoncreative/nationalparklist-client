...
export class AppProvider extends Component {
  ...
  // get park information from the National Parks API
  // when a user clicks on a park's "More" button or the Park name link in the dashboard.
  ...
  // handles whether a user has added a park to their dashboard,
  // allowing to conditionally render "add park to list button"
  ...
  // record the index of the item clicked, obtain current list,
  // splice it out, reset state with new length
